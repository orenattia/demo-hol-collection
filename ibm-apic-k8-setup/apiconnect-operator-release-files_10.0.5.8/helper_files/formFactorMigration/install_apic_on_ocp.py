...
LTS_PN_CHANNEL = "v6.0"
LTS_APIC_CHANNEL = "v3.8"  # check for correct values before GA
LTS_APIC_VERSION = "10.0.5.8" # check for correct values before GA
...
ltsRelease = True
LTS_OCP_VERSIONS = ["4.12", "4.14"] # check for correct values before GA
...
pn_catalog_source_dailybuild = {
  ...
  "spec": {
    ...
    "sourceType": "grpc",
    "image": "cp.stg.icr.io/cp/ibm-integration-platform-navigator-catalog:latest-lts",
    "updateStrategy": {
      "registryPoll": {
        "interval": "45m"
      }
...
parser.add_argument("-pn_catsrc_image", "--pn_catsrc_image", dest = "pn_catsrc_image", help="When using -custom_build option, platform navigator catalog source image value. This is optional and defaulted to cp.stg.icr.io/cp/ibm-integration-platform-navigator-catalog:latest-lts if not provided.")
