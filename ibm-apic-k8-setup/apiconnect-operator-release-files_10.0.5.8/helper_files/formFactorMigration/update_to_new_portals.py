    ...
    if selectedSubsystem == None:
        ...
        for eachPortalEndpoint in registeredPortalsInTarget:
            ...
            if args.dont_use_toolkit_for_portal_backup:
                allbackupInfo = runKubernetesCommand("get portalbackup -o yaml", args.ptl_ns, True)
                keyName = "items"
            else:
...
parser.add_argument('-dont_use_toolkit_for_portal_backup', "--dont_use_toolkit_for_portal_backup", dest = "dont_use_toolkit_for_portal_backup", help='If this flag is used, portal backups are obtained using kubectl get portalbackups command. Default it uses apic --mode portaladmin backups:list to get portal backups. Use this flag when only DR(no change in endpoints) is performed.')
