...
LTS_APIC_CHANNEL = "v5.2-sc2"  # check for correct values before GA
LTS_DP_CHANNEL = "v1.11-sc2"  # check for correct values before GA
LTS_APIC_VERSION = "10.0.8.0" # check for correct values before GA
LTS_APIC_PROFILES = ["n1xc7.m48", "n1xc16.m72", "n3xc16.m64"]

#CD RELEASE
CD_CP4I_VERSION = "16.1.1" # check for correct values before GA
CD_PN_CHANNEL = "v8.0" # check for correct values before GA
CD_APIC_CHANNEL = "v6.0" # check for correct values before GA
CD_DP_CHANNEL = "v1.13"  # check for correct values before GA
CD_APIC_VERSION = "10.0.9.0" # check for correct values before GA
CD_APIC_PROFILES = ["n1xc7.m48", "n1xc16.m72", "n3xc16.m64"]

# keep changing this value based on the branch LTS OR CD branch 
ltsRelease = False
LTS_OCP_VERSIONS = ["4.12", "4.14", "4.15", "4.16", "4.17"] # check for correct values before GA
...
def install_catalog_sources_and_subscribe():
    ...
    if args.custom_build == False:
        ...
        if args.cert_manager_type == None:
